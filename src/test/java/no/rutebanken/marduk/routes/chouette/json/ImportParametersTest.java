...
public class ImportParametersTest {
    ...
    final String gtfsReferenceJson =  "{ \"parameters\": { \"gtfs-import\": {\"clean_repository\": \"true\", \"no_save\": \"0\", " +
    ...
    final String regtoppReferenceJson =  "{\"parameters\":{\"regtopp-import\":{\"name\":\"test\",\"no_save\":\"0\",\"clean_repository\":\"true\"," +
