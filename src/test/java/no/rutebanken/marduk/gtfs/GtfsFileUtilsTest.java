...
public class GtfsFileUtilsTest {
    ...
    public void mergeGtfsFiles_identicalFilesShouldYieldMergedFileIdenticalToOrg() throws Exception {
        ...
        assertTrue(ZipFileUtils.listFilesInZip(merged).stream().anyMatch(n -> GtfsFileUtils.FEED_INFO_FILE_NAME.equals(n)));
    }
    ...
    public void mergeWithTransfers() throws Exception {
        ...
        File tmpZip = TempFileUtils.createTempFile(Files.readAllBytes(merged.toPath()), "marduk-test-mergeWithTransfers-", ".zip");
