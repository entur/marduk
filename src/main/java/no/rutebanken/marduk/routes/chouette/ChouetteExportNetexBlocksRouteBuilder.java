...
import static no.rutebanken.marduk.Constants.ENABLE_BLOCKS_EXPORT;
...
public class ChouetteExportNetexBlocksRouteBuilder extends AbstractChouetteRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("entur-google-pubsub:ChouetteExportNetexBlocksQueue").streamCaching()
                ...
                .process(e -> e.getIn().setHeader(JSON_PART, Parameters.getNetexExportProvider(getProviderRepository().getProvider(e.getIn().getHeader(PROVIDER_ID, Long.class)), exportStops, true))) //Using header to addToExchange json data
