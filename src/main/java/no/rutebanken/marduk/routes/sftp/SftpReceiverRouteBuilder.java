...
public class SftpReceiverRouteBuilder extends BaseRouteBuilder {
    ...
    private static final class DynamcSftpPollerRouteBuilder extends BaseRouteBuilder {
        ...
        @Override
        public void configure() throws Exception {
            from("sftp://" + provider.sftpAccount + "@" + sftpHost + "?privateKeyFile=" + sftpKeyFile + "&knownHostsFile=" + knownHostsFile + "&sorter=#caseIdSftpSorter&delay={{sftp.delay}}&localWorkDirectory=files/tmp&connectTimeout=1000")
