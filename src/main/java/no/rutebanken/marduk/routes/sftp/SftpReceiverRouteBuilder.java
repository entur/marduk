...
public class SftpReceiverRouteBuilder extends TransactionalBaseRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        singletonFrom("sftp://" + sftpUser + "@" + sftpHost + "?privateKeyFile=" + sftpKeyFile + "&recursive=true&sorter=#caseIdSftpSorter&delay={{sftp.delay}}&delete={{idempotent.skip:false}}&localWorkDirectory=files/tmp&connectTimeout=1000")
