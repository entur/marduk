...
public class SftpReceiverRouteBuilder extends BaseRouteBuilder {
    ...
    private static final class DynamcSftpPollerRouteBuilder extends RouteBuilder {
        ...
        @Override
        public void configure() throws Exception {
            from("sftp://" + provider.sftpAccount + "@" + sftpHost + "?privateKeyFile=" + sftpKeyFile + "&delay=30s&delete=true&localWorkDirectory=files/tmp&readLock=changed&readLockCheckInterval=10000")
