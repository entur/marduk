 ...
 */
@Component
public class Otp2NetexGraphBuilder extends AbstractKubernetesJobRunner implements OtpGraphBuilder {
    ...
    protected List<EnvVar> getEnvVars(String otpWorkDir) {
        ...
        envVars.add(new EnvVar(OTP_GRAPH_MODE, "--loadStreet", null));
