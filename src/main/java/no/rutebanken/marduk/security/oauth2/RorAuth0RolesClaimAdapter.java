...
/**
 * Insert a "roles" and "realm_access" claims in the JWT token based on the namespaced "roles" claim and the "permissions" claim, for compatibility with the existing
